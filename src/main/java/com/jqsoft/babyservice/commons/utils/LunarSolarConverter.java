...
public class LunarSolarConverter {
    ...
    // 阳历节日
    private static String[] holidays_1 = {"1-1","4-4","4-5","4-6","5-1","10-1","10-2","10-3","10-4","10-5","10-6","10-7"};
    // 公历节日
    private static String[] holidays_2 = {"1-1","1-2","1-3","5-5","8-15"};
    ...
    public static boolean isHolidays(Date date){
        ...
        // 阳历节日判断
        String solarDay = month + "-" + days;
        for (String day : holidays_1) {
            if (day.equals(solarDay)) {
                return true;
            }
        }
        ...
        String lunarDay = lunar.lunarMonth + "-" + lunar.lunarDay;
        for (String day : holidays_2) {
            if (day.equals(lunarDay)) {
                return true;
            }
        }
...
//        Solar solar = new Solar();
//        solar.solarYear = 2025;
//        solar.solarMonth = 11;
//        solar.solarDay = 15;
////        System.out.println(dump(solar));
//        Lunar lunar = LunarSolarConverter.SolarToLunar(solar);
//        System.out.println(JSONObject.toJSONString(lunar));
//        solar = LunarSolarConverter.LunarToSolar(lunar);
//        System.out.println(dump(solar));
//        System.out.println(LunarSolarConverter.lunarYearToGanZhi(2015));
        System.out.println(LunarSolarConverter.isHolidays(DateUtil.parseDate("2016-09-15","yyyy-MM-dd")));
    }
